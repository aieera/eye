...
export default function ScreenToolbar({ view, setView, search, setSearch }) {
  ...
  return (
    <div className="flex justify-between items-center">
      ...
      {/* Add Screens */}
      <button onClick={()=>navigate("/screens/new")} className="bg-purple-900 text-white px-5 py-3 rounded-xl shadow hover:bg-purple-800">
        + Add Screens
      </button>
